...
--Задача 1: Выведите количество студентов из таблицы students, по которым не было проведено ни одного урока
            --(то есть они отсутствуют в таблице classes).
select count(*)
...
--Задача 10: Постройте распределение студентов, которые никогда не платили, по регионам проживания (столбец region_name).
            --Исключите студентов, у которых нет информации о регионе проживания, и выведите топ-5 городов по кол-ву студентов.
